...
describe('Quotes', () => {
  it('should be able to marshall into json.', () => {
    const expectedQuoteJsonString = '{"projectPlatform":"string","projectType":"string","contact":{"firstName":"Aman1","lastName":"Abrol1","email":"aman@gmail.com","phone":{"id":1,"number":"5554958","type":"home"},"address":{"street":["16241N30thPl","1200"],"city":"phoenix","state":"az","zip":"85032","county":"genesee","country":"USA"}},"company":{"name":"privateLLP","type":"LLP","budget":{"min":15000,"max":100000},"url":"https://www.google.com","timeline":{"min":"4","max":"7"},"description":"Test","establishedYear":2014}}';
