...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private window: Window, public scrollToService: ScrollToService,
              private dynamicComponentService: DynamicComponentService, private route: ActivatedRoute) {}
  ...
  ngAfterViewInit() {
    this.dynamicComponentService.createComponent(this.landingPageContainer, this.#layoutId).then(componentCreated => {
